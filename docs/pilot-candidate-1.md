...
Dieser Pilotkandidat ist als doctrine-konformer Blueprint vorbereitet, bleibt aber als sekundaerer Cloudflare-Pfad bis zu den fehlenden Freigaben und Inputs im Status `approval_required`.
