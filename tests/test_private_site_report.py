...
class PrivateSiteReportTests(unittest.TestCase):
    ...
    def test_build_private_site_report_detects_short_meta_and_multiple_h1(self) -> None:
        ...
        self.assertEqual(report["automation_candidates"][0]["action_type"], "rank_math_meta_description_update")
        ...
        self.assertEqual(report["automation_candidates"][0]["automation_contract_id"], "ac-rank-math-meta-description-update-v1")
        ...
        self.assertIn("Automation contract: `ac-rank-math-meta-description-update-v1`", markdown)
